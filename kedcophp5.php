...
<body class="mybody">
  ...
  <?php
       if(isset($_POST['submit'])){
       	...
       	echo "The Area of a Circle Pi*(r*r) is ".$Circle."<br>";
  ...
  ?>
   ...
   <button class="nextbutton"><a href="kedcophp4.php">Previous</a></button>
   <button class="nextbutton"><a href="kedcophp6.php">Next</a></button>
</body>
</html>